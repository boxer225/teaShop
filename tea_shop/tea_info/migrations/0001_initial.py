    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tea_info.category')),
                ('comment', models.ManyToManyField(blank=True, related_name='comments', to='tea_info.comments')),
            ],
            options={
                'verbose_name': 'Товар',
